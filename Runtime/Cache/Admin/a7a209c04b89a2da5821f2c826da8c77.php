...
<div class="page-container">
	<form action="" method="post" class="form form-horizontal" id="form-product-add" style="overflow: hidden;" enctype="multipart/form-data" >
		<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-1" style=" width: 135px;"><span class="c-red">*</span>出价：</label>
			<div class="formControls col-xs-8 col-sm-5">
				<input type="text" class="input-text" value="<?php echo ($info['u_price']); ?>" placeholder="不低于0.58" id="price" name="price" style=" width:200px;">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-10 skin-minimal">
				<div class="check-box">
					<input type="checkbox" aria-required="true" value="<=18"  id="wifi-1" name="age">
					<label for="wifi-1"><=18</label>
				</div>
				<div class="check-box">
					<input type="checkbox" value="19-24"  id="wifi-2" name="age">
					<label for="wifi-2">19-24</label>
				</div>
				<div class="check-box">
					<input type="checkbox" value="25-29"  id="wifi-3" name="age">
					<label for="wifi-3">25-29</label>
				</div>
				<div class="check-box">
					<input type="checkbox" value="30-39"  id="wifi-4" name="age">
					<label for="wifi-4">30-39</label>
				</div>
				<div class="check-box">
					<input type="checkbox" value="40-49"  id="wifi-5" name="age">
					<label for="wifi-5">40-49</label>
				</div>
				<div class="check-box">
					<input type="checkbox" value=">=50"  id="wifi-6" name="age">
...
<script type="text/javascript">
    ...
    function save_submit(id) {
        if ($('#price').val().length<=0||$('#price').val()<0.58){
            layer.msg('价格不能低于0.58!',{icon: 0,time:1000});
            return false;
        }else{
            ...
            for(var i=1;i<7;i++){
                if ($('#wifi-'+i).prop('checked')){
                    ageid.push("wifi-"+i);
                    getvalue=$('#wifi-'+i).val();
                    agevalue.push(getvalue);
                }
            }
            console.log(diqu);
