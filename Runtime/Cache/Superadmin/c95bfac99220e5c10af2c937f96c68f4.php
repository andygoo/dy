...
<div class="page-container">
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<?php if(is_array($shopinfo)): foreach($shopinfo as $key=>$v): ?><tr class="text-c">
				...
				<td><?php if($v["dopenstatus"] == 1): ?><span class='label label-success radius'>已通过</span><?php elseif($name == 0): ?><span class='label label-defaunt radius'>待审核</span><?php else: ?><span class='label label-defaunt radius'>已拒绝</span><?php endif; ?></td>
				<td><a title="立即充值" href="javascript:;" onclick="Customer_show('立即充值', '/Admin/RechargeAdd/132',  '550','300')" style="text-decoration:none">立即充值</a></td>
				...
				<td><span class='label label-success radius'>开启中</span></td>
				<td class="f-14">
					<a title="拒绝" href="javascript:;" onclick="Customer_show('填写拒绝理由', '/Admin/CustomerRefuse/132', '550','400')" style="text-decoration:none">拒绝</a>
					<a title="编辑" href="javascript:;" onclick="member_edit('编辑','<?php echo u('Accountlist/editchild?did=$v.did');?>','4','','510')" style="text-decoration:none">编辑</a>
					&nbsp;| &nbsp;
					<a title="充值记录" href="javascript:;" onclick="record_list('充值记录', 'record-list.html','880','520')" style="text-decoration:none">充值记录</a>
					&nbsp;| &nbsp;
					<a title="每日统计" href="javascript:;" onclick="record_list('每日统计', 'everydaycount.html', '880','520')" style="text-decoration:none">每日统计</a>
					&nbsp;| &nbsp;
					<a title="重置密码" href="javascript:;" onclick="record_list('重置密码', 'setpassword.html',  '600','350')" style="text-decoration:none">重置密码</a>
					&nbsp;| &nbsp;
					<a title="模拟登陆" href="/douyin/index.php/admin?sid=<?php echo ($v["did"]); ?>" target="_blank" style="text-decoration:none">模拟登陆</a>
				</td>
...
<script type="text/javascript" src="/douyin/Public/admin/lib/datatables/1.10.0/jquery.dataTables.min.js"></script>
<script type="text/javascript" src="/douyin/Public/admin/lib/laypage/1.2/laypage.js"></script>
