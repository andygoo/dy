			...
			<div class="formControls col-xs-8 col-sm-9">
				<?php if($detail["dyinyeimg"] == 'images/nopic.png' ): ?><button type="button" class="layui-btn" style="display: block;background-color: #5a98de;"  id="test1">上传营业执照</button>
					<span class="btn-upload form-group" style="height: auto;">
						<input type="hidden" id="uploadyyimg" required="required" name="dyinyeimg" multiple="true" value="/douyin/Public/images/nopic.png"/>
						<a href="javascript:deleteyinyeimg();" title="点击删除"><img style="display: none;" id="deleteyy" src="/douyin/Public/admin/static/h-ui/images/uploadify-cancel.png">
						</a>
					...
					<span class="btn-upload form-group" style="height: auto;">
						...
						<a href="javascript:deleteyinyeimg();" title="点击删除"><img style="display: true;" id="deleteyy" src="/douyin/Public/admin/static/h-ui/images/uploadify-cancel.png">
						</a>
						<img class="layui-upload-img" src="/douyin/Public/<?php echo ($detail["dyinyeimg"]); ?>"  id="demo1" style="display: true;" width="100" height="100">
						<p id="demoText1"></p>
					</span><?php endif; ?>
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<?php if($detail["dicpimg"] == 'images/nopic.png' ): ?><button type="button" class="layui-btn" style="display: block;background-color: #5a98de;"  id="test2">上传ICP备案执照</button>
					<span class="btn-upload form-group" style="height: auto;">
						<input type="hidden" id="uploadicpimg" required="required" name="dicpimg" multiple="true" value="/douyin/Public/images/nopic.png"/>
						<a href="javascript:deleteicpimg();" title="点击删除"><img style="display: none;" id="deleteicp" src="/douyin/Public/admin/static/h-ui/images/uploadify-cancel.png">
						</a>
					...
					<span class="btn-upload form-group" style="height: auto;">
						...
						<a href="javascript:deleteicpimg();" title="点击删除"><img style="display: true;" id="deleteicp" src="/douyin/Public/admin/static/h-ui/images/uploadify-cancel.png">
						</a>
						<img class="layui-upload-img" src="/douyin/Public/<?php echo ($detail["dicpimg"]); ?>"  id="demo2" style="display: true;" width="100" height="100">
						<p id="demoText2"></p>
					</span><?php endif; ?>
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<?php if($detail["dotherimg"] == 'images/nopic.png' ): ?><button type="button" class="layui-btn" style="display: block;background-color: #5a98de;" id="test3">上传图片</button>
					<span class="btn-upload form-group" style="height: auto;">
						<input type="hidden" id="uploadother" required="required" name="dotherimg" multiple="true" value="/douyin/Public/images/nopic.png"/>
						<a href="javascript:deleteotherimg();" title="点击删除"><img style="display: none;" id="deleteother" src="/douyin/Public/admin/static/h-ui/images/uploadify-cancel.png">
						</a>
					...
					<span class="btn-upload form-group" style="height: auto;">
						...
						<img class="layui-upload-img" src="/douyin/Public/<?php echo ($detail["dotherimg"]); ?>"  id="demo3" style="display: true;" width="100" height="100">
						<p id="demoText3"></p>
					</span><?php endif; ?>
			</div>
		</div>
...
<script>
    function save_submit() {
        if($('#username').val().length<=0){
           ...
           $.post("/douyin/Superadmin/Accountlist/editchild.html?did=1/editchild",
			   {
			       data:getdata
			   },function (e) {
				e=JSON.parse(e);
