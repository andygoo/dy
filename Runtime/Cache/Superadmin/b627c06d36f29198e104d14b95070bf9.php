		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<input type="hidden" id="uploadyinye" required="required" name="dyinyeimg" multiple="true" value="images/nopic.png"/>
					<a href="javascript:deleteyinyeimg();" title="点击删除"><img style="display: none;margin-left: 120px;" id="deleteyinye" src="/douyin/Public/admin/static/h-ui/images/uploadify-cancel.png">
					</a>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<input type="hidden" id="uploadicp" required="required" name="dicpimg" multiple="true" value="images/nopic.png"/>
					<a href="javascript:deleteicpimg();" title="点击删除"><img style="display: none;margin-left: 120px;" id="deleteicp" src="/douyin/Public/admin/static/h-ui/images/uploadify-cancel.png">
					</a>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<input type="hidden" id="uploadother" required="required" name="dotherimg" multiple="true" value="images/nopic.png"/>
					<a href="javascript:deleteotherimg();" title="点击删除"><img style="display: none;margin-left: 120px;" id="deleteother" src="/douyin/Public/admin/static/h-ui/images/uploadify-cancel.png">
					</a>
