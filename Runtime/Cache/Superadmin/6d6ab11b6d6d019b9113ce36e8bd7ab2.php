			...
			<div class="formControls col-xs-8 col-sm-9">
				<?php if($detail["dotherimg"] == 'images/nopic.png' ): ?><button type="button" class="layui-btn" style="display: block;background-color: #5a98de;" id="test3">上传图片</button>
					...
					<span class="btn-upload form-group" style="height: auto;">
						...
						<img class="layui-upload-img" src="/dy/Public/<?php echo ($detail["dotherimg"]); ?>"  id="demo3" style="display: true;" width="100" height="100">
						<p id="demoText3"></p>
					</span><?php endif; ?>
			</div>
		</div>
...
<script>
    function save_submit() {
        if($('#username').val().length<=0){
           ...
           $.post("/dy/Superadmin/Accountlist/editchild.html?did=2/editchild",
			   {
			       data:getdata
			   },function (e) {
				e=JSON.parse(e);
